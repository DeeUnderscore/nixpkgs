...
python3Packages.buildPythonApplication rec {
  ...
  # we skip anything upstream ci doesn't run, and additionally also the web
  # scraping plugin tests, since we do not enable the optional web scrape
  # feature, and these plugins are going away in 1.1.0
  checkPhase = ''
